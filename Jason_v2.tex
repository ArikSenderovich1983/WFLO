...
Specifically, for most instances, \qclsgrb{} gives the best solutions at 3600 seconds, \textcolor{purple}{while the DA-based approach \qulsda{}
...
the \ilplsgrb{} method starts with poor solutions, and ends up improving over \qcssgrb{} after around 2 seconds.}
...
When compared
to the other LS-based methods, the DA speed-up is even larger than when compared to \qclsgrb{}.  \textcolor{purple}{At $1$ ($10$) seconds, the mean speedup factor compared to \ilplsgrb{} 
...
\begin{table}[t!]
	...
	\vspace{0.5em}
	\caption{\textcolor{purple}{Speedup factor per LS-based method for all instances w.r.t \qulsda{} at 10 second. The value 360 implies a lower bound on the speedup factor.}}\label{tab:results4}
\end{table}
...
compared to DA at 10 seconds. \textcolor{purple}{The average lower bound on the speedup at $1$ seconds
