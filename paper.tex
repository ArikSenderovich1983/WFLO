...
the integer linear programming (ILP-LS) approach from~\cite{donovan2005wind,Zhang2014}, and the 
model that uses a quadratic approximation (QP-SS)~\cite{turner2014new}. 
The ILP model is given in the following set of equations, which we denote WFL-ILP, \begin{eqnarray} \label{ILP}
...
The CP approach presented in~\cite{Zhang2014} was
