...
indicate that the solver has achieved an LS solution within 3600 seconds that turned out to be worse
than a DA solution after 1 (or 10 seconds). \todo{JCB: What is the difference between ``N/A'' and 3600/360?} The average lower bound on the speedup at $1$ seconds
