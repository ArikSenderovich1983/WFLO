...
magnitude lower \todo{Eldan: shorter instead of lower?} run-time.
...
Our main results are: \begin{itemize}
	\item \quls{} when solved using the Digital Annealer (DA) achieves a solution quality as good or better (within time limit) than existing state-of-the-art exact methods on 10 of 12 instances.
...
\todo{Eldan regarding the first sentence in what follows: I feel like this is not well defined? MRE is a single metric. Do you mean that our approahces have the best MRE both after a short time period (of say 10 seconds) but also at longer time limits (including 3600)?} Our proposed quadratic models, \qcls{} and \quls{},
...
Our results show empirically that the quadratic programming models that we
