...
Similar, linear formulations have been previously proposed and solved using exaxt solvers~\cite{Zhang2014,donovan2005wind}. \todo{Are these linear formulations ``equivalent'' as you claimed or approximations? If they are mathematically equivalent, why do we think a quadratuc model will be any better computationally?}
