...
must be large enough to ensure that the solutions are indeed feasible wrt the problem constraints.
...
\subsection{The Computational Complexity of WFLO}
...
We therefore provide a straightforward proof of the computational complexity of the QCOP defined above. 

\begin{mythm}
	The computational complexity of the QCOP defined in \eqref{QCOP}-\eqref{Vars} is $\mathcal{NP}$-hard. 
\end{mythm}
\begin{myproof}
We prove by showing that a special case of the QCOP \eqref{QCOP}-\eqref{Vars}  is
