...
WFL-QCOP is a type of strictly convex integer 
quadratically constrained optimization problem (IQCOP), which is notorious for its computational complexity~\cite{van1981another}. In fact,
we proved in Section~\ref{sec:computational} that WFL-QCOP is $\mathcal{NP}$-hard. The common exact methods for solving
