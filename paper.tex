...
In recent years, there has been a growing need to efficiently solve WFLO~\cite{wilson2013learning,wilson2014continuous},
...
sometimes even thousands, of turbines. The layout design
...
and performing sensitivity analysis on those values~\cite{wilson2018evolutionary}.
...
quadratic problems, we enjoy the best of both worlds: we are able to provide fast as well as high performing solutions (in terms of the total energy). Therefore, our approach achieves the desired balance between efficiency and effectiveness of the resulting design,
%, a hardware-based
